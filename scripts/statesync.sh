...
# Initialize chain.
catanead init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.catanead/config/

wget -O ~/.catanead/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
