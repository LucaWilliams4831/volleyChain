...
# previous node state folder. By default this is './build/.catanead:/root/.catanead'
...
the test suite exports `/.catanead` folder from the docker container
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/evmos/evmos/v10/cmd/catanead/root.go:243 +0x2ca
        ...
        main.main()
            github.com/evmos/evmos/v10/cmd/catanead/main.go:20 +0x45
